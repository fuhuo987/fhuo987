...
<li class="dhl"><div class="sekuai"></div><a href="#jianjie">简介</a></li>

<li class="dhl"><div class="sekuai"></div><a href="#sjg">世界观</a></li>

<li class="dhl"><div class="sekuai"></div><a href="#ml">角色目录</a></li>
...
dhlbs(box[0].childNodes[1]);

} else if(scrollTop>=800&&scrollTop<1400){

dhlbs(box[1].childNodes[1]);

}else if(scrollTop>=1400){

dhlbs(box[2].childNodes[1]);

}

else{box.forEach(function(b){

b.style.backgroundColor='';

b.childNodes.forEach(function(c){c.style.color='black'; });

});}

}

window.onscroll=ymgdjl(juli,200);
...
b.parentNode.childNodes[1].style.color='black';

});

var xz=a.parentNode.childNodes[0];

xz.classList.add('highlight');

a.style.color='#FAFAD2';
