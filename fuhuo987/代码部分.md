...
<li class="dhl"><a href="#hj">后记</a></li>
...
width="400px" style="float: right;user-select: none;" title="点击进入283PRO"></a>
...
<div class="jieshaowenben" id="hj">

<div style="border-left: 10px solid rosybrown ;">

<h1 style="color: aqua;">后记</h1>

</div>

<ul>

<li>以上就是复活的前端试验性demo，属于原型机（），有很多不足，也有很多想法没能实现，但这个寒假也算学到了一些东西</li><br>

<li>该后记的出现并不表示该页面的更新就此停止，它作为试验场我之后想到什么好玩的功能就会优先放在这里进行试验</li>

<br>

<li><span class="heimu">诶？要不最后我放一个意见收集栏</span></li>
...
<input type="text" placeholder="Producername" id="pname">

<button class="tj" type="button">提交</button>

<button class="shanchu" type="button">清空</button>

<textarea name="pl" id="plq" class="plk" rows="5" cols="50" placeholder="在此写下你想说的话" maxlength="283" value></textarea>

<div class="counter">

当前字数:&nbsp;&nbsp;<span id="count">0</span>/283
...
### 1.js
```
function wenhou(){var currentDate = new Date();
...
let textarea=document.querySelector('.plk')
...
var btn1=document.querySelector('.tj')
...
let text=document.querySelector('.plk')

let pname=document.getElementById('pname')

if(text.value.trim()!==''){

res=tj(text.value.trim(),pname.value.trim())
...
async function tj(text,id){

var res=await fn2(text,id)

var plk=document.querySelector('.plk')

plk.placeholder=res

let bh=setTimeout(function(){

plk.placeholder='在此写下你想说的话'
...
var textarea=document.querySelector('.plk')
...
const text = document.querySelector('.plk').value;
...
const total = chineseChars.length + otherChars;
...
}else{wordcount.style.color='black'}
...
if(pl[pname]!==undefined){

var cnt=1

var nm=pname

while(pl[pname]!==undefined){
